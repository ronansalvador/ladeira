...
// //       const data = await response.json() // ✅ só uma vez
...
//       <ToastContainer />
//       <div className="w-full max-w-md bg-gray-500 rounded-2xl shadow-lg p-6 sm:p-8">
...
//             onChange={({ target }) => setEmail(target.value)}
//             autoComplete="username"
//             className="w-full border bg-gray-500 border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"
//           />
//           <PasswordInput
//             passwordValue={password}
//             placeholder="digite sua senha"
...
//             <Link
//               href="/register"
//               className="w-full sm:w-auto text-center bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium px-5 py-2 rounded-lg transition-colors"
//             >
//               Registrar
//             </Link>
//           </div>
